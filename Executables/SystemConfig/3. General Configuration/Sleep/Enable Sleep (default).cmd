...
if %errorlevel%==1 (
	start "Enabling Hibernation" "%windir%\SystemConfig\3. General Configuration\Hibernation\Enable Hibernation.cmd"
) else (
	start "Disabling Hibernation" "%windir%\SystemConfig\3. General Configuration\Hibernation\Disable Hibernation (default).cmd"
)

echo.
echo Sleep has been enabled.
