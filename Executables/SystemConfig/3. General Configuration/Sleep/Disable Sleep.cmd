...
if %errorlevel%==1 (
	call "%windir%\SystemConfig\3. General Configuration\Hibernation\Disable Hibernation (default).cmd" /silent
) else (
	call "%windir%\SystemConfig\3. General Configuration\Hibernation\Enable Hibernation.cmd" /silent
)

echo.
echo Sleep has been disabled.
