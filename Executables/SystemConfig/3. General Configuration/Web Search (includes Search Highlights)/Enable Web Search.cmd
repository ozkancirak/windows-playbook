...
:: Main settings
call "%windir%\SystemRuntime\Scripts\ConfigureSettingsPages.cmd" /unhide search-permissions /silent
(
...
if %errorlevel%==1 call "%windir%\SystemConfig\3. General Configuration\Search Indexing\Enable Search Indexing.cmd" /silent & set ____restart=true
exit /b