...
if not defined silent (
	echo This removes the legacy File Explorer search redirect applied by the
	echo classic-search tweak. It can fix blank Microsoft Visual C++ Runtime
	echo Library errors coming from explorer.exe.
	echo]
	pause
	cls
)
