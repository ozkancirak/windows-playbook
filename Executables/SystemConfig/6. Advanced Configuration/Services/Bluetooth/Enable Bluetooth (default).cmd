...
call ToggleDevices.cmd -Silent -Enable '*Bluetooth*'
...
if %ERRORLEVEL% == 1 call "%windir%\SystemConfig\4. Interface Tweaks\Context Menus\Send To\Debloat Send To Context Menu.cmd" -Enable @('Bluetooth')
if %ERRORLEVEL% == 2 call "%windir%\SystemConfig\4. Interface Tweaks\Context Menus\Send To\Debloat Send To Context Menu.cmd" -Disable @('Bluetooth')
