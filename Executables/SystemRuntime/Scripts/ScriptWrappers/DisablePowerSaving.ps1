...
# Duplicate and customize the Ultimate Performance power scheme
...
powercfg /changename scheme_current "Maximum Performance" "Power scheme optimized for optimal latency and performance."
...
& "$windir\SystemRuntime\Scripts\ToggleDevices.cmd" -Disable '@("ACPI Processor Aggregator", "Microsoft Windows Management Interface for ACPI")' | Out-Null
