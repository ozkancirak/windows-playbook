...
$packageInstall = "$windir\SystemRuntime\Scripts\packageInstall.ps1"
...
function Menu {
	...
	Write-BulletPoint @"
Removing the package restores the telemetry components, which can aid in troubleshooting.
"@
	Write-BulletPoint @"
The playbook retains policies that should disable telemetry even after the package removal. These policies
