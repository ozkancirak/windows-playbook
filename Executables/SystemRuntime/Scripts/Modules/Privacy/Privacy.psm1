...
function Disable-RecallSnapshots {
    Start-Process -FilePath "reg" -ArgumentList "import `"SystemConfig\3. General Configuration\AI Features\Recall\Disable Recall Support (default).reg`"" -NoNewWindow -Wait
}
